...
2. Follow `buildkite storing secrets in environment hooks <https://buildkite.com/docs/pipelines/secrets#without-a-secrets-storage-service-exporting-secrets-with-environment-hooks>`_
