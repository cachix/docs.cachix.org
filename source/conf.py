...
project = 'Cachix docs'
copyright = u'2016-2020, Enlambda OÜ'
...
latex_documents = [
    (master_doc, 'cachix-docs.tex', 'cachix-docs Documentation',
...
man_pages = [
    (master_doc, 'cachix-docs', 'cachix-docs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cachix-docs', 'cachix-docs Documentation',
     author, 'cachix-docs', 'One line description of project.',
     'Miscellaneous'),
]
