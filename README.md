...
`public/_headers` makes browsers revalidate documents and search assets on every
visit, even when the Cloudflare zone has a higher browser cache TTL. Astro's
fingerprinted assets retain the host's normal caching policy.
