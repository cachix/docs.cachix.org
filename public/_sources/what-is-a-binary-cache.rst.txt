...
A :term:`binary cache` is the server that stores and serves these prebuilt results.

Without a binary cache
----------------------
...
Where Cachix fits in
--------------------

`Cachix <https://cachix.org>`_ provides hosted binary caches so you can store and share your own build results.
...
To get started, see :ref:`installation` and :ref:`getting-started`.
