...
slug: "continuous-integration-setup/gitlab.html"
---

<span id="gitlab-ci" class="legacy-anchor"></span>
...
3. Follow [variables configuration tutorial](https://docs.gitlab.com/ee/ci/variables/#creating-a-custom-environment-variable)
