---
title: "Hydra"
description: "You’ll need to deploy all build machines with a post build hook ."
slug: "continuous-integration-setup/hydra.html"
---

<span id="hydra" class="legacy-anchor"></span>

You’ll need to deploy all build machines with a [post build hook](https://nixos.org/manual/nix/stable/advanced-topics/post-build-hook.html).
